...
extern const JSClass  *jsb_${current_class.underlined_class_name}_class;
extern JSObject *jsb_${current_class.underlined_class_name}_prototype;

bool js_${generator.prefix}_${current_class.class_name}_constructor(JSContext *cx, uint32_t argc, JS::Value *vp);
